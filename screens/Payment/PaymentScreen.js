...
import { createBookingAPI } from "../../services/workshop";
  ...
  const handleUpiAppPayment = async (appName) => {
    ...
    try {
      ...
      if (canOpen) {
        ...
        // Fallback: Open UPI Intent or Direct Payment Confirmation
        await Linking.openURL(upiUrl);
      }

      // Complete Booking API Process
        ...
        <View style={styles.methodToggleRow}>
          ...
          >
            <MaterialCommunityIcons
              name="qrcode-scan"
              size={18}
              color={paymentMethod === "QR" ? COLORS.textWhite : COLORS.primary}
            />
            <Text
              style={[
                styles.methodText,
          ...
          <View style={styles.methodBox}>
            ...
            {[
              ...
              <TouchableOpacity
                ...
                disabled={loading}
              >
                <Ionicons name={app.icon} size={20} color={COLORS.primary} />
          ...
          <View style={styles.methodBox}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(v) => setCardForm({ ...cardForm, number: v })}
              />
            </View>
            ...
            >
              {loading ? (
                ...
                <Text style={styles.payNowText}>Pay ₹{amount} Securely</Text>
              )}
            </TouchableOpacity>
          </View>
        )}
